...
namespace com.bricksandmortarstudio.TheCrossing.Data
{
    ...
    /// 
    /// </summary>
    public partial class VolunteerTrackingContext : Rock.Data.DbContext
    {

        #region Models

        public DbSet<VolunteerMembership> VolunteerMemberships { get; set; }
        ...
        /// </summary>
        public VolunteerTrackingContext()
            : base( "RockContext" )
        {
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<VolunteerTrackingContext>( new NullDatabaseInitializer<VolunteerTrackingContext>() );
